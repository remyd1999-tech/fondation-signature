(() => {
  ...
  const NAME_TITLE_GAP = 1;
  const TEXT_TO_LOGO_GAP = 26;
  const LOGO_WIDTH = 330;
  ...
  function buildSignatureHtml(person) {
    ...
    return [
      ...
      "  <tr>",
      `    <td align="left" style="padding:0;margin:0;font-family:Helvetica,Arial,sans-serif;font-size:${FONT_SIZE}px;line-height:${LINE_HEIGHT}px;font-weight:bold;color:#000000;">`,
      `      ${name}`,
      "    </td>",
      "  </tr>",
      "  <tr>",
      `    <td align="left" style="padding:${NAME_TITLE_GAP}px 0 0 0;margin:0;font-family:Helvetica,Arial,sans-serif;font-size:${FONT_SIZE}px;line-height:${LINE_HEIGHT}px;font-style:normal;font-weight:normal;color:#000000;">`,
      `      ${title}`,
      "    </td>",
      "  </tr>",
      "  <tr>",
      `    <td align="left" style="padding:0;margin:0;font-size:0;line-height:0;height:${TEXT_TO_LOGO_GAP}px;">&nbsp;</td>`,
      "  </tr>",
      "  <tr>",
